...
```{r}
LowFlowManagementType <- "PC7Proposed2030WithAMWGInflowThresholds"   #options currently are "AMWG", "PC7Proposed2025","PC7Proposed2030","ORRP", "AMWG201908_15Day","Section42a". AMWG201908_15Day15 is the same as AMWG, except assessments are made every 15 days."AMWG20190827_1Day2030" has the minimum flows and thresholds that match the AMWG submission on PC7.
...
ProjectDirectory <- "H:\\RD Projects\\RD18004_Lake Opuha Further Work\\Potential Available Volume"               #At Rainfall.NZ via connection to Aqualilnc server
...
InflowsTeAnaWaiRockwoodSnowFile          <- file.path(DataDirectory, "TimeSeriesData.csv")
LakeStorageOperatingIntentFile           <- file.path(DataDirectory, "LakeStorageOperatingIntent.csv")
#LakeStorageOperatingIntentFile           <- file.path(DataDirectory, "LakeStorageOperatingIntent-90pctMax.csv")
```
...
ParameterAveraging <- list(AMWG= c(LakeLevel = 7, Inflows = 30, Snow = 30),
                           AMWG15= c(LakeLevel = 7, Inflows = 30, Snow = 30),
                           ...
                           AMWG201908_15Day=c(LakeLevel = 7, Inflows = 30, Snow = 30),
                           AMWG20190827_1Day2030=c(LakeLevel = 7, Inflows = 30, Snow = 30),
...
for (DateNumber in index(LimitedPeriod)) {#
  ...
  if (AssessmentDay) {
    ...
    if (LowFlowManagementType %in% c("PC7Proposed2025","PC7Proposed2030","PC7Proposed2030withAMWGMinFlows","PC7Proposed2030withAMWGRestrictions","PC7Proposed2030withDailyThresholds","PC7Proposed2030variableLakeThreshold","PC7Proposed2030WithAMWGInflowThresholds")) {
      ...
      if (LowFlowManagementType %in% c("AMWG","AMWG201908_15Day","AMWGwithMonthlyThresholds","AMWGwithOC7MinFlows","AMWGwithPC7Restrictions","AMWG20190827_1Day2030")) {
